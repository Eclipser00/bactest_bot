...
STRATEGIES = [
    ...
    # DosMedias,
    # make_multi(Tres_Medias_Filtered),
...
# ALEATORIO
N1_RANGE = np.arange(15, 30, 5).tolist() # NO SE PUEDEN PASAR DECIMALES VAYA MIERDA...
N2_RANGE = np.arange(40, 70, 10).tolist() # PORQUE BACKTRADER NO LO ADMITE EN LOS INDICADORES...
N3_RANGE = np.arange(150, 200, 50).tolist() # ULTIMO DATO NO SE ITERA
...
PERIODS_PER_YEAR = 252 # Se utiliza para calcular las métricas de rendimiento, como Sharpe Ratio, Sortino Ratio, etc..
...
OPTIMIZE_MAXIMIZE = 'Sharpe Ratio'
...
SUMMARY_FIRST_COL = 'Win Rate [%]'

# ==================== ANÁLISIS DE ROBUSTEZ ====================
# Activar/desactivar cada tipo de análisis
USE_CSCV = True                # CSCV + PBO (Combinatorial Symmetric Cross-Validation)
